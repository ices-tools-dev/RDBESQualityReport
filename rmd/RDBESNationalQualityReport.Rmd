...
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE, error = FALSE, fig.height = 10, fig.width = 14)
...
list.of.packages <- c("icesVocab", "ggplot2", "tidyverse", "eurostat", "DT", "rnaturalearth", "rnaturalearthdata", "sf", "mapplots", "kableExtra", "ggpubr", "remotes", "htmltools", "knitr", "rstudioapi", "ggalluvial")
...
```{r}
# Transform kg to t 
CL$CLoffWeight <- round(CL$CLoffWeight/1000, digits = 3)
CL$CLsciWeight <- round(CL$CLsciWeight/1000, digits = 3)
```
