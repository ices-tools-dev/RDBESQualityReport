...
The following tables show summary values between the years. If the difference between the years exceeds 30% they are highlighted <span style="color:red">red</span>. The most recent year is used for the comparison. 
